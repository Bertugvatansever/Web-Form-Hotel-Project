<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tur.aspx.cs" Inherits="NESNE_PROJE_ÖDEVİ.Tur" %>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item active"><a href="Tur.aspx" class="nav-link">Tur</a></li>
                        <li class="nav-item"><a href="Otel.aspx" class="nav-link">Oteller</a></li>
            ...
            <div class="container">
                <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
                    <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
                        <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="Default.aspx">Ana Sayfa</a></span> <span>Tur</span></p>
                        <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Konum</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                        ...
                        <div class="sidebar-wrap bg-light ftco-animate">
                            ...
                            <form action="#">
                                <div class="fields">
                                    ...
                                    <div class="form-group">
                                        <asp:Button ID="btn_search" runat="server" Text="Araştır" class="btn btn-primary py-3 px-5" OnClick="btn_search_Click" />
                                    </div>
                                </div>
                            </form>
                        </div>
                        <div class="sidebar-wrap bg-light ftco-animate">
                            ...
                            <form method="post" class="star-rating">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="besYildiz" runat="server" value="5">
                                    <label class="form-check-label" for="exampleCheck1">
                                        <p class="rate"><span><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i></span></p>
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="dortYildiz" runat="server" value="4">
                                    <label class="form-check-label" for="exampleCheck1">
                                        <p class="rate"><span><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star-o"></i></span></p>
                                    </label>
                                </div>
                                <div class="form-check">
                                    <asp:CheckBox ID="UYildiz" runat="server" class="form-check-input"/>
                                    <label class="form-check-label" for="exampleCheck1">
                                        <p class="rate"><span><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star-o"></i><i class="icon-star-o"></i></span></p>
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="ikiYildiz" runat="server" value="2">
                                    <label class="form-check-label" for="exampleCheck1">
                                        <p class="rate"><span><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star-o"></i><i class="icon-star-o"></i><i class="icon-star-o"></i></span></p>
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="birYildiz" runat="server" value="1">
                                    <label class="form-check-label" for="exampleCheck1">
                    ...
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <asp:Repeater ID="repeaterTurList" runat="server">
                                <ItemTemplate>
