<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Restoran.aspx.cs" Inherits="NESNE_PROJE_ÖDEVİ.Restoran" %>
...
<body>
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('images/arkaplan.jpg');">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="Default.aspx">Ana Sayfa</a></span> <span>Restoran</span></p>
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Restoran</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
        	<div class="col-lg-3 sidebar ftco-animate">
        		<div class="sidebar-wrap bg-light ftco-animate">
        			...
        			<form action="#">
		              ...
		              <div class="form-group">
                          <asp:Button ID="Btn3" runat="server" Text="Button" class="btn btn-primary py-3 px-5" OnClick="Btn3_Click" />
		              </div>
		            </div>
	            </form>
        		</div>
          ...
          <div class="col-lg-9">
          	<div class="row">
				  <%--Buraya eklenecek--%>
          		<asp:Repeater ID="repeaterRestoranList" runat="server">
                                <ItemTemplate>
                                    <div class="col-md-4 ftco-animate">
                                        <div class="destination">
                                            ...
                                            <div class="text p-3">
                                                <div class="d-flex">
                                                    <div class="one">
                                                        <h3><a href="#"> <%# Eval("restoranAdi")%></a></h3>
                                                        <p class="rate">
                                                            <p><%# Eval("ulkeAdi")%></p>
                                                            <p> <%# Eval("sehirAdi")%> </p>
